...
const isKeyboardInput = (e: React.SyntheticEvent | Event) => e instanceof KeyboardEvent || (e as React.SyntheticEvent).nativeEvent instanceof KeyboardEvent;
const focusNearestDescendant = (el: HTMLElement | null) => { const first = el?.querySelector<HTMLElement>('[tabindex]'); first?.focus(); };
